  ...
  function () {
    ...
    function RelativeTimeFormat() {
      ...
      if (!(fields instanceof Object)) {
        throw new TypeError("Expected the LocaleDataEntry for locale: '".concat(dataLocale, "' to be an Object"));
    ...
    _createClass(RelativeTimeFormat, [{
      ...
      value: function format(value, unit) {
        ...
        var relativeTimeFormat = this; // If Type(relativeTimeFormat) is not Object, throw a TypeError exception.

        if (!(relativeTimeFormat instanceof Object)) {
          throw new TypeError("Method Intl.RelativeTimeFormat.prototype.format called on incompatible receiver ".concat(this.toString()));
      ...
      value: function formatToParts(value, unit) {
        ...
        if (!(relativeTimeFormat instanceof Object)) {
          throw new TypeError("Method Intl.RelativeTimeFormat.prototype.formatToParts called on incompatible receiver ".concat(this.toString()));
        } // If relativeTimeFormat does not have an [[InitializedRelativeTimeFormat]] internal slot, throw a TypeError exception.
      ...
      value: function resolvedOptions() {
        ...
        if (!(relativeTimeFormat instanceof Object)) {
          throw new TypeError("Method Intl.RelativeTimeFormat.prototype.resolvedOptions called on incompatible receiver ".concat(this.toString()));
        } // If relativeTimeFormat does not have an [[InitializedRelativeTimeFormat]] internal slot, throw a TypeError exception.
      ...
      value: function supportedLocalesOf(locales) {
        ...
        var options = arguments[1]; // Let availableLocales be %RelativeTimeFormat%.[[AvailableLocales]].

        var availableLocales = RELATIVE_TIME_FORMAT_STATIC_INTERNALS.availableLocales; // Let requestedLocales be ? CanonicalizeLocaleList(locales).
